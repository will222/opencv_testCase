...
class SURFFLANNMatchingHomography {
    public void run(String[] args) {
        String filenameObject = "F:\\workspace\\opencv_test\\src\\main\\java\\com\\will\\opencv\\opencv_test\\feature2d\\book.png";
        String filenameScene = "F:\\workspace\\opencv_test\\src\\main\\java\\com\\will\\opencv\\opencv_test\\feature2d\\boxinscene.png";
...
//        MSER fd = MSER.create();
        ...
        fd.detectAndCompute(imgObject, new Mat(), keypointsObject, descriptorsObject);
        fd.detectAndCompute(imgScene, new Mat(), keypointsScene, descriptorsScene);
